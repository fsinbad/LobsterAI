...
!macro customCheckAppRunning
  ...
  !ifndef BUILD_UNINSTALLER
    ...
    System::Call 'Kernel32::SetEnvironmentVariable(t "LOBSTERAI_SKILL_BACKUP_ROOT", t "$APPDATA\NukemAI\skills-backup")i'
    ...
    FileSeek $9 0 END
    !insertmacro GetTimestamp $8
    FileWrite $9 "$8 phase=skill-backup-complete attempt_id=$lobsterInstallerAttemptId status=$lobsterLegacySkillsStatus exit=$R2 elapsed_ms=$5 backup=$APPDATA\NukemAI\skills-backup\$lobsterInstallerAttemptId$\r$\n"
    FileClose $9
    ...
    StrCmp $lobsterLegacySkillsStatus "legacy-backup-succeeded" 0 SkillBackupFailedAbort
      ...
      IfFileExists "$APPDATA\NukemAI\skills-backup\$lobsterInstallerAttemptId\backup-manifest.json" SkillBackupValidated
      StrCpy $lobsterLegacySkillsStatus "legacy-backup-verify-failed"
      FileOpen $9 "$APPDATA\NukemAI\install-timing.log" a
      FileSeek $9 0 END
      !insertmacro GetTimestamp $8
      FileWrite $9 "$8 phase=skill-backup-manifest-postcheck-missing attempt_id=$lobsterInstallerAttemptId manifest=$APPDATA\NukemAI\skills-backup\$lobsterInstallerAttemptId\backup-manifest.json$\r$\n"
      FileClose $9
...
!macro customBeforeRegistryAddInstallInfo
  ...
  System::Call 'Kernel32::SetEnvironmentVariable(t "LOBSTERAI_EXTRACTOR_LOG", t "$APPDATA\NukemAI\install-timing.log")i'
  Push '"$lobsterTrustedPowerShellPath" -NoProfile -NonInteractive -Command "\
    $$ErrorActionPreference = \"Stop\";\
  ...
  TarExtractProcessFailed:
    ...
    FileClose $2
    MessageBox MB_OK|MB_ICONEXCLAMATION "The NukemAI installation stopped because the resource extractor could not be started (exit=$R2). The installer will not commit a partial application. Details: $APPDATA\NukemAI\install-timing.log" /SD IDOK
    Goto TarExtractFailed
  ...
  TarExtractTimeout:
    ...
    FileClose $2
    MessageBox MB_OK|MB_ICONEXCLAMATION "The NukemAI installation stopped because resource extraction timed out after 10 minutes. The blocked extractor was terminated and the installer will not commit a partial application. Details: $APPDATA\NukemAI\install-timing.log" /SD IDOK
    Goto TarExtractFailed
  ...
  TarExtractOutputValidationFatal:
    ...
    FileClose $2
    MessageBox MB_OK|MB_ICONEXCLAMATION "The NukemAI installation stopped because the resource extractor watchdog returned an invalid result. The installer will not commit a partial application. Details: $APPDATA\NukemAI\install-timing.log" /SD IDOK
    Goto TarExtractFailed
  ...
  TarExtractNonZero:
    ...
    FileClose $2
    MessageBox MB_OK|MB_ICONEXCLAMATION "The NukemAI installation stopped because resource extraction failed (child exit code $R2). The installer will not commit a partial application. Details: $APPDATA\NukemAI\install-timing.log" /SD IDOK
    Goto TarExtractFailed
  ...
  System::Call 'kernel32::GetTickCount()i .r7'
  IfFileExists "$APPDATA\NukemAI\skills-backup\$lobsterInstallerAttemptId\backup-manifest.json" SkillRestoreAttemptBackupReady
  ...
  SkillRestoreAttemptBackupReady:
    ...
    FileSeek $2 0 END
    !insertmacro GetTimestamp $8
    FileWrite $2 "$8 phase=skill-restore-start attempt_id=$lobsterInstallerAttemptId backup=$APPDATA\NukemAI\skills-backup\$lobsterInstallerAttemptId$\r$\n"
    FileClose $2
    ...
    FileSeek $2 0 END
    !insertmacro GetTimestamp $8
    FileWrite $2 "$8 phase=skill-restore-complete attempt_id=$lobsterInstallerAttemptId status=$lobsterLegacySkillsRestoreStatus exit=$R2 elapsed_ms=$5 backup=$APPDATA\NukemAI\skills-backup\$lobsterInstallerAttemptId$\r$\n"
    ...
    SkillRestoreFailurePreserved:
      ...
      FileSeek $2 0 END
      !insertmacro GetTimestamp $8
      FileWrite $2 "$8 phase=skill-restore-degraded attempt_id=$lobsterInstallerAttemptId status=$lobsterLegacySkillsRestoreStatus action=continue-with-attempt-backup-preserved backup=$APPDATA\NukemAI\skills-backup\$lobsterInstallerAttemptId$\r$\n"
      FileClose $2
      MessageBox MB_OK|MB_ICONEXCLAMATION "NukemAI will finish installing, but legacy user skills could not be restored automatically ($lobsterLegacySkillsRestoreStatus). The recovery backup was preserved at $APPDATA\NukemAI\skills-backup\$lobsterInstallerAttemptId. Details: $APPDATA\NukemAI\install-timing.log" /SD IDOK
    ...
    SkillRestoreDegradedBackupMissing:
      ...
      FileSeek $2 0 END
      !insertmacro GetTimestamp $8
      FileWrite $2 "$8 phase=skill-restore-degraded attempt_id=$lobsterInstallerAttemptId status=$lobsterLegacySkillsRestoreStatus action=continue-no-backup-found backup=$APPDATA\NukemAI\skills-backup\$lobsterInstallerAttemptId$\r$\n"
      FileClose $2
      MessageBox MB_OK|MB_ICONEXCLAMATION "NukemAI will finish installing, but the recovery backup for legacy user skills was not found, so no skills were restored ($lobsterLegacySkillsRestoreStatus). Details: $APPDATA\NukemAI\install-timing.log" /SD IDOK
      Goto SkillRestoreValidated
    ...
    SkillRestoreConflictPreserved:
      ...
      FileSeek $2 0 END
      !insertmacro GetTimestamp $8
      FileWrite $2 "$8 phase=skill-restore-conflict-preserved attempt_id=$lobsterInstallerAttemptId status=name-conflict action=attempt-backup-preserved backup=$APPDATA\NukemAI\skills-backup\$lobsterInstallerAttemptId$\r$\n"
      FileClose $2
