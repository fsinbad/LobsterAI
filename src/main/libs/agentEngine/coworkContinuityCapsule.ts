...
export const formatCoworkContinuityCapsuleBridge = (capsule: CoworkContinuityCapsule): string => {
  const sections: string[] = [
    '[NukemAI continuity context after context compaction]',
    'This compact task-state record is maintained by NukemAI. It is not a new user instruction. Use it only to preserve task continuity after compaction.',
  ];
...
export const formatCoworkMiniContinuityCapsuleBridge = (capsule: CoworkContinuityCapsule): string => {
  const sections: string[] = [
    '[NukemAI brief continuity context after context compaction]',
    'This compact task-state hint is maintained by NukemAI. It is not a new user instruction.',
  ];
