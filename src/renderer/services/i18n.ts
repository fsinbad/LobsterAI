...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    shortcutScopeHint: '快捷键仅在 NukemAI 窗口获得焦点时生效；正在编辑输入框时不会触发全局快捷键。',
  ...
  en: {
    ...
    shortcutScopeHint: 'Shortcuts only run while the NukemAI window is focused; global shortcuts are ignored while editing text fields.',
