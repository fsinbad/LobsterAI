...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    aiSkinCreationGuide: '可前往“专家套件”使用「NukemAI 外观定制」，或直接开始创作。',
    ...
    aiSkinDeleteManagedCopyNote: '只会删除 NukemAI 管理的皮肤副本，不会删除会话中的原始生成图片或卸载 AI 皮肤设计师套件。',
    aiSkinDeleteFailed: '删除皮肤失败，请重试',
    uiFontSize: 'UI 字号',
    uiFontSizeDescription: '调整 NukemAI 界面使用的基准字号',
    codeFontSize: '代码字体大小',
    ...
    copied: '已复制',
    copyrightHolder: 'NukemAI. All rights reserved.',
...
shortcutScopeHint:
    ...
    shortcutDescNewChat: '开始一个新的 NukemAI 任务',
    shortcutDescFocusPrompt: '跳回 NukemAI 并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到 NukemAI 任务视图',
    ...
    dailyCheckInLoginHint: '登录只在 NukemAI 客户端中完成，活动不会获取账号令牌',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 NukemAI Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
...
artifactPreviewCardLobsterBrowser: 'NukemAI 浏览器',
    artifactPreviewCardOpenInLobsterBrowser: '在 NukemAI 浏览器中打开',
    ...
    coworkWorkingDirectoryHint: 'NukemAI 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 NukemAI 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 NukemAI 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'NukemAI 使用模型设置中的当前模型与提供商配置。',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入 NukemAI 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入 NukemAI 数据备份？',
    ...
    coworkConfigSaveFailed: '保存 NukemAI 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'NukemAI 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'NukemAI 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkHomeTagline: '我是 NukemAI，你的全场景办公 Agent',
    ...
    coworkGoalInputPlaceholder: 'NukemAI 应继续朝哪个目标努力？',
    ...
    coworkErrorModelSourceNukemAIPlan: 'NukemAI 套餐',
    ...
    dshSettingsDesc: '内置 DeepSeek 官方开源 agent 框架（dsh）。启用后，NukemAI 的模型供应商配置会自动同步给 dsh。',
    ...
    browserWebAccessDescription: '使用 NukemAI 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: 'NukemAI 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription: '默认开启。关闭后仅作为 NukemAI 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: 'NukemAI 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 NukemAI 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 NukemAI 可以打开此域名',
    ...
    notificationSystemPermissionHint: '若未收到通知，请在系统设置中允许 NukemAI 发送通知。',
    ...
    usageAnalyticsEnabled: '帮助改进 NukemAI',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: 'NukemAI服务协议',
    privacyDialogDesc: '在使用NukemAI之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: 'NukemAI服务协议',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用NukemAI',
    welcomeSubtitle: '超多AI功能等你探索～',
    welcomePromo: '新用户限时送百万Token',
    welcomeLogin: '登录',
    welcomeCustomModel: '自定义模型',
    welcomeAgreementNotice: '继续即表示您已阅读并同意{link}',
    welcomeAgreementLinkText: '《网易有道NukemAI服务协议》',
  ...
  en: {
    ...
    aiSkinCreationGuide: 'Use “Customize NukemAI” in Expert Kits, or start here.',
    ...
    aiSkinDeleteManagedCopyNote: 'Only NukemAI-managed skin copies are removed. Original images in the conversation and the AI Skin Designer kit are kept.',
    aiSkinDeleteFailed: 'Failed to delete the skin. Please try again.',
    uiFontSize: 'UI font size',
    uiFontSizeDescription: 'Adjust the base size used for the NukemAI UI',
...
shortcutScopeHint:
      'Shortcuts only run while the NukemAI window is focused; while a text field is focused, only shortcuts with a Cmd/Ctrl modifier trigger.',
    ...
    shortcutOpenCowork: 'Open NukemAI',
    ...
    shortcutDescNewChat: 'Start a new NukemAI task',
    shortcutDescFocusPrompt: 'Return to NukemAI and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the NukemAI task view',
    ...
    dailyCheckInLoginHint: 'Login is handled by NukemAI; the activity never receives account tokens',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit NukemAI Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    siteQuotaChooseHint: 'Choose an online site. NukemAI will never stop one automatically.',
...
artifactPreviewCardLobsterBrowser: 'NukemAI Browser',
    artifactPreviewCardOpenInLobsterBrowser: 'Open in NukemAI Browser',
    ...
    // NukemAI
    cowork: 'NukemAI',
    coworkSettings: 'NukemAI Settings',
    ...
    coworkWorkingDirectoryHint: 'NukemAI will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for NukemAI...',
    coworkSystemPromptHint: "Optional system prompt to customize NukemAI's behavior",
    ...
    coworkModelSettingsHint:
      'NukemAI uses the current model and provider configuration from Model Settings.',
    ...
    openClawDataBackupBlockingTitle: 'Backing up NukemAI data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import NukemAI data',
    ...
    openClawDataMigrationConfirmTitle: 'Import NukemAI data backup?',
    ...
    coworkConfigSaveFailed: 'Failed to save NukemAI settings. Please try again.',
    ...
    coworkPermissionDescription: 'NukemAI is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'NukemAI needs your input',
    ...
    coworkHomeTagline: "I'm NukemAI, your all-in-one office agent",
    ...
    coworkGoalInputPlaceholder: 'What goal should NukemAI keep working toward?',
    ...
    coworkGatewaySessionSyncTimeout:
      'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add NukemAI to your antivirus allowlist.',
    ...
    coworkErrorModelSourceNukemAIPlan: 'NukemAI plan',
    ...
    dshSettingsTitle: 'DeepSeek Harness',
    dshSettingsDesc: 'Bundles DeepSeek\'s official open-source agent framework (dsh). Once enabled, NukemAI\'s model provider configuration syncs into dsh automatically.',
    ...
    browserBlockedHostnamesDescription: 'NukemAI will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means NukemAI will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means NukemAI can open this domain',
    ...
    notificationSystemPermissionHint:
      'If you are not receiving notifications, allow NukemAI to send notifications in the system settings.',
    ...
    usageAnalyticsEnabled: 'Help improve NukemAI',
    ...
    // Privacy dialog
    privacyDialogTitle: 'NukemAI Terms of Service',
    privacyDialogDesc:
      'Before using NukemAI, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'NukemAI Terms of Service',
    privacyDialogAccept: 'I have read and agree',
    privacyDialogReject: 'Decline',
    welcomeTitle: 'Welcome to NukemAI',
    ...
    welcomeAgreementLinkText: 'NetEase Youdao NukemAI Terms of Service',
