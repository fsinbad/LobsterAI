...
This guide walks through testing the entire Web Search Skill integration with NukemAI.

## Prerequisites

1. NukemAI built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with NukemAI.

**Steps:**

1. Start NukemAI in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of NukemAI launch.
...
1. Open a terminal while NukemAI is running
...
**Objective:** Verify graceful shutdown of services when NukemAI quits.

**Steps:**

1. With NukemAI running and searches completed, quit the application
...
1. Start NukemAI (ensure headless is false in config)
...
- ✅ Server auto-starts with NukemAI
